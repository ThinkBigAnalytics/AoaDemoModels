...
from teradataml.analytics.sqle import DecisionForestPredict
...
def evaluate(data_conf, model_conf, **kwargs):
    ...
    predicted = DecisionForestPredict(
                               object=model,
                               newdata=dataset,
                               id_column=model_conf["idcolumn"],
                               detailed=False,
    ...
    df_pred = df_pred.assign(err =df_pred[true_label] - df_pred.prediction )
